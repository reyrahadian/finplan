...
namespace FinPlan.Infrastructure.EntityFramework.Migrations
{
    ...
    [Migration("20190303103348_Transaction_ChangeDate_ToNonNullable")]
    partial class Transaction_ChangeDate_ToNonNullable
    {
            ...
            modelBuilder.Entity("FinPlan.Domain.Transactions.Transaction", b =>
                {
                    ...
                    b.HasOne("FinPlan.Domain.Transactions.TransactionCategory", "TransactionCategory")
                        .WithMany()
